...
export function LunaticConfirmationModal(
  props: LunaticComponentProps<'ConfirmationModal'>,
) {
  const { id, label, description, goNextPage, goPreviousPage, backPage } = props
